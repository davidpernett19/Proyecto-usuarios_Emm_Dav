...
export default function Login({ setLogueado, setCrear }) {
  ...
  return (
    <div className="feid-bg vh-100 d-flex justify-content-center align-items-center">
      <div className="card feid-card p-4" style={{width:"350px"}}>
        ...
        />
        <button className="btn feid-btn w-100 mb-3" onClick={entrar}>Entrar</button>
        <button className="btn btn-secondary w-100" onClick={()=>setCrear(true)}>Crear Usuario</button>
      </div>
    </div>
  )
}
